...
class TestCheckForged(unittest.TestCase):
    ...
    def test_check_forged_in_whitelist_true(self):
...
class TestCheckToFrom(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_check_address = patch(
            "pad.plugins.wlbl_eval.WLBLEvalPlugin.check_address_in_list").start()
        self.mock_check_whitelist = patch(
            "pad.plugins.wlbl_eval.WLBLEvalPlugin._check_whitelist").start()
    ...
    def test_check_from_in_default_whitelist(self):
        list_name = "from_in_default_whitelist"
        self.plug.check_from_in_default_whitelist(self.mock_msg)
        self.mock_check_whitelist.assert_called_with(self.mock_msg, list_name)
